...
class Backupper:  # pylint: disable=too-few-public-methods
    ...
    def run(self, destination: str | None = None, password: str | None = None) -> Iterator[tuple[str, bool]]:
        ...
        return self._archiver.create_archives(archives, destination=destination, password=password, verbose=self._verbose)
